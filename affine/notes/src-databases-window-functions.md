...
# Types
![](../../images/databases__Pasted%20image%2020250506212339.png)
## Агрегирующие функции
> Агрегируют значения по указанному столбцу без свёртки как у `GROUP BY`!
![](../../images/databases__Pasted%20image%2020250506212226.png)
* Ключевой синтаксис - `OVER` + `PARTITION BY`
![](../../images/databases__Pasted%20image%2020250506212541.png)
## Ранжирующие функции
