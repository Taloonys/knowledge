# Оглавление
* [Algo-math](resources/algo-math.md)
...
* [Sorting methods1 - old](resources/sorting.md)
* [Sorting algorithms2 - new](resources/sortings.md)
* [Too advanced (never gonna be used in interviews)](resources/adv-algo.md)
# Real cases
| Общий концепт                                   | Про что                                              | обычно черз..<br>(убрать потом)   | мои попытки...             |
| ----------------------------------------------- | ---------------------------------------------------- | --------------------------------- | -------------------------- |
| **LRU Cache / LFU Cache**                       | Реализация кеша с вытеснением по частоте или времени | `HashMap + List / Heap`           | [here](resources/lru-lfu-caching.md) |
