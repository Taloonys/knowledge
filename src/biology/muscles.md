...
- анаэробный гликолиз -> лактат и ионы ацидоза, накопление ионов = жжение в мышцах (тут уже чистая химическая проблема)
	- есть ещё *молочная кислота* тут, но она очень кратковременная производная
