...
### Tips
- очень важно, что если условие и wait идут по порядку где-то, то сначала нужно выставить условие, а потом только wait (это просто sanity tip)
...
# Lock-free структуры
> Это специальные структуры данных для синхронизации, которые не используют мьютексы, не блокируют ничего. Он строятся строго на "попытайся локнуть, добавить, прочитать..."
