...
# Upper bits
![Pasted image 20250227165917](../../images/common__Pasted%20image%2020250227165917.png)
...
![Pasted image 20250227165113](../../images/common__Pasted%20image%2020250227165113.png)

# Additional code
* 00000011-> 3
* 10000011 -> -3
![Pasted image 20250227165625](../../images/common__Pasted%20image%2020250227165625.png)

# Decimal relation
* 10001011 -> pow(1, 0) + pow(1, 1) + pow(0, 2) + pow(1, 3) + pow(0, 4) + pow(0, 5) + pow(0, 6) + pow(1, 7) = 11

![Pasted image 20250227170028](../../images/common__Pasted%20image%2020250227170028.png)
